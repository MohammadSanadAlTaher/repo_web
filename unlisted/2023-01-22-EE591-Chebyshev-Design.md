---
layout: articles
permalink: /Q2hlYnlzaGV2IENvdXBsZXIgRGVzaWduIE1BVExBQiBTY3JpcHQ
date: 2023-01-22
sitemap: false
noindex: true
---
...
<h2 style="text-align:center;">Chebyshev Coupler Design MATLAB Script</h2>

<br>

This MATLAB script was written for my graduation project. The user is prompted to input the desired coupling factor, minimum directivity,
number of holes, and if port 4 is isolated. The offset, spacing, and radii will be output, and the upper and lower passband edges will be calculated.
Additionally, plots of the standard coupling factor, thickness-corrected coupling factor, and directivity will be produced.

<br>

<p style="text-align:center;">View below or <a href="{{site.url}}{{site.baseurl}}/assets/code_files/chebyshev_design.m">
click here</a> to download the .m file
</p>
