!function(){"use strict";
    ...
    var n=function(t,e){var n=e.length,
        ...
        r=new function()
        {
            this.matches=function(e,t)
            {
                ...
                (t=t.trim().toLowerCase()).split(" ").filter(function(t){return 0<=e.indexOf(t)}).length===t.split(" ").length)}},
        d={put:function(t)
            {
                        ...
                        var u=function(t,e,n,r)
                        {
                            for(const i in t)
                                if(!function(n,r)
                                {
                                    ...
                                    return!1}(t[i],r.exclude)&&n.matches(t[i],e))
                                    return t}(e[t],n,r,i);
                        u&&o.push(u)
                    }
                    return o
    ...
    var m=function y(t){if(!(e=t)||!("undefined"!=typeof e.required&&e.required instanceof Array))
    ...
    {
        var n;0<o.validate(t).length&&a("You must specify the following required options: "+r),
        i=w.merge(i,t),
        f.setOptions
        ({
